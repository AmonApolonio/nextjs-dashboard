...
async function seedInvoices(sqlInstance: typeof sql) {
  await sqlInstance`CREATE EXTENSION IF NOT EXISTS "uuid-ossp"`;
...
async function seedCustomers(sqlInstance: typeof sql) {
  await sqlInstance`CREATE EXTENSION IF NOT EXISTS "uuid-ossp"`;
...
async function seedRevenue(sqlInstance: typeof sql) {
  await sqlInstance`
